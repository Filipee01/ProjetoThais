...
export default function Main() {
    ...
    return(
      ...
      <section className="sections section1">
        ...
        <div>
          <img className="image-profile" src="Images/me cuted.png" alt="programming" />
        </div>
      </section>
      <section className="sections section2">
        ...
        <h3 className="learning">Estou aprendendo:</h3>
        <div className="wrapp-images-bot">
          <img src="" alt="REACT"/>
          <img src="" alt="C++"/>
        </div>
